...
const MarketingPage: React.FC<MarketingPageProps> = ({ onGetStarted, onViewAssets }) => {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-white selection:text-black overflow-x-hidden">
      ...
      {/* 2. Hero Section */}
      <section className="pt-32 pb-20 px-4 relative overflow-hidden bg-dot-pattern bg-black">
        ...
        <div className="max-w-7xl mx-auto relative min-h-[600px] flex flex-col items-center justify-center text-center z-10">
            ...
            <div className="relative z-20 max-w-4xl mx-auto animate-fadeIn">
                <div className="mb-8 flex justify-center animate-float">
                    <img src="https://iili.io/fIDzzRS.png" alt="Infinity Logo" className="w-24 h-24 rounded-2xl shadow-2xl border-4 border-black" />
                </div>
                ...
                <p className="text-xl text-gray-400 max-w-xl mx-auto mb-10 font-light leading-relaxed">
            ...
            <div className="absolute top-0 left-0 md:left-20 xl:left-40 hidden md:block animate-float">
                <div className="w-64 bg-zinc-800 p-6 rounded-sm shadow-xl rotate-[-6deg] relative border border-zinc-700 hover:rotate-0 transition-transform duration-500 text-white">
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-red-500 shadow-sm border-2 border-zinc-800"></div>
                    <p className="font-handwriting text-zinc-300 text-lg leading-snug">
                        Ask Gemini to summarize the Q3 financial report from Notion...
                    </p>
                </div>
                <div className="absolute top-20 -left-10 bg-zinc-900 p-3 rounded-2xl shadow-lg border border-zinc-800 animate-float-delayed">
            ...
            <div className="absolute top-10 right-0 md:right-20 xl:right-40 hidden md:block animate-float-delayed">
                <div className="w-72 bg-zinc-900/80 backdrop-blur-xl p-5 rounded-[24px] shadow-2xl border border-white/10 rotate-[3deg] hover:rotate-0 transition-transform duration-500">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="font-bold text-white text-lg">Briefings</h3>
                        <span className="text-xs text-gray-400">Today</span>
                    </div>
                    <div className="flex items-center gap-4 p-3 bg-black rounded-2xl shadow-sm border border-zinc-800 mb-3">
                         <div className="w-10 h-10 rounded-full bg-red-900/20 flex items-center justify-center text-red-500">
                             <Bell size={18} />
                         </div>
                         <div className="text-left">
                             <div className="font-bold text-sm text-white">Morning Update</div>
                             <div className="text-xs text-gray-500">Call with marketing team</div>
                         </div>
                    </div>
                     <div className="flex items-center gap-2 text-xs bg-blue-900/30 text-blue-400 px-3 py-1.5 rounded-lg w-fit">
                        <Activity size={12} /> 09:00 - 09:15
                    </div>
                </div>
                 <div className="absolute -top-6 -right-6 bg-zinc-900 p-4 rounded-2xl shadow-lg border border-white/10 animate-float">
            ...
            <div className="absolute bottom-0 left-0 md:left-10 xl:left-32 hidden md:block animate-float-horizontal">
                 <div className="w-80 bg-zinc-900 p-6 rounded-[24px] shadow-2xl border border-white/10 rotate-[3deg] hover:rotate-0 transition-transform duration-500">
                    <h3 className="font-bold text-white mb-4 text-left">Today's Searches</h3>
                    <div className="space-y-3">
                        <div className="flex items-center gap-3 p-3 bg-black rounded-xl border border-zinc-800">
                            <div className="w-6 h-6 rounded bg-orange-900/50 flex items-center justify-center text-orange-400 text-xs font-bold">N</div>
                            <div className="text-sm font-medium text-gray-300">New Ideas for campaign</div>
                        </div>
                         <div className="flex items-center gap-3 p-3 bg-black rounded-xl border border-zinc-800">
                            <div className="w-6 h-6 rounded bg-green-900/50 flex items-center justify-center text-green-400 text-xs font-bold">S</div>
                            <div className="text-sm font-medium text-gray-300">Spotify: Top Hits</div>
                        </div>
                    </div>
            ...
            <div className="absolute bottom-10 right-0 md:right-10 xl:right-32 hidden md:block animate-float">
                <div className="bg-zinc-900 p-6 rounded-[32px] shadow-2xl border border-white/10 rotate-[-3deg] hover:rotate-0 transition-transform duration-500">
                    <h3 className="font-bold text-white mb-4 text-sm uppercase tracking-wider text-left">100+ Integrations</h3>
                    <div className="flex items-center gap-4">
                        <div className="w-14 h-14 bg-black border border-zinc-800 rounded-2xl flex items-center justify-center shadow-sm">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/e/e9/Notion-logo.svg" className="w-8 h-8 opacity-80" alt="Notion"/>
                        </div>
                        <div className="w-14 h-14 bg-black border border-zinc-800 rounded-2xl flex items-center justify-center shadow-sm -mt-4">
      ...
      <section className="py-24 px-6 bg-zinc-900/20">
          ...
          <div className="max-w-7xl mx-auto">
              <div className="mb-16 text-center">
                   <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Everything you need, instantly.</h2>
                   <p className="text-zinc-500 max-w-2xl mx-auto">Our AI engine connects the dots between your apps and the open web.</p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-2 gap-6 h-[800px] md:h-[600px]">
                  
                  {/* Card 1: Visual Search (Large) */}
                  <div className="md:col-span-2 row-span-2 bg-zinc-900 rounded-[32px] border border-white/10 p-8 shadow-sm hover:border-white/20 transition-all relative overflow-hidden group">
                      <div className="absolute top-8 left-8 z-10 pointer-events-none">
                          <div className="w-12 h-12 bg-blue-900/30 text-blue-400 rounded-2xl flex items-center justify-center mb-4">
                              <LayoutGrid size={24} />
                          </div>
                          <h3 className="text-2xl font-bold mb-2 text-white">Visual First Search</h3>
                          <p className="text-gray-400 max-w-sm">Browse results in a stunning gallery view. Perfect for designers, photographers, and visual thinkers.</p>
                      </div>
                      
                      {/* Real Image Grid UI */}
                      <div className="absolute bottom-0 right-0 w-3/4 h-3/4 bg-black/50 rounded-tl-[32px] border-t border-l border-white/10 p-4 grid grid-cols-2 gap-4 opacity-80 group-hover:opacity-100 transition-opacity overflow-hidden">
                          <img src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=400&q=80" className="rounded-xl shadow-sm h-full w-full object-cover transform group-hover:translate-y-2 transition-transform duration-700 opacity-80" alt="Abstract" />
                          <img src="https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&w=400&q=80" className="rounded-xl shadow-sm h-full w-full object-cover transform group-hover:-translate-y-2 transition-transform duration-700 opacity-80" alt="Neon" />
                          <img src="https://images.unsplash.com/photo-1542202229-7d93c33f5d07?auto=format&fit=crop&w=400&q=80" className="rounded-xl shadow-sm h-full w-full object-cover transform group-hover:translate-y-2 transition-transform duration-700 delay-100 opacity-80" alt="Forest" />
                          <img src="https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?auto=format&fit=crop&w=400&q=80" className="rounded-xl shadow-sm h-full w-full object-cover transform group-hover:-translate-y-2 transition-transform duration-700 delay-100 opacity-80" alt="City" />
                      </div>
                  </div>

                  {/* Card 2: AI Brain */}
                  <div className="bg-white text-black rounded-[32px] p-8 shadow-xl relative overflow-hidden group">
                      ...
                      <div className="relative z-10">
                          <div className="w-10 h-10 bg-black/5 rounded-xl flex items-center justify-center mb-4 backdrop-blur-md text-black">
                              <Sparkles size={20} />
                          </div>
                          <h3 className="text-xl font-bold mb-2">Powered by Gemini</h3>
                          <p className="text-black/60 text-sm">Advanced reasoning across documents and web sources. Context-aware and secure.</p>
                      </div>
                  </div>

                  {/* Card 3: Privacy */}
                  <div className="bg-zinc-900 rounded-[32px] border border-white/10 p-8 shadow-sm hover:border-white/20 transition-all relative overflow-hidden group">
                       <div className="relative z-10">
                          <div className="w-10 h-10 bg-green-900/30 text-green-400 rounded-xl flex items-center justify-center mb-4">
                              <Lock size={20} />
                          </div>
                          <h3 className="text-xl font-bold mb-2 text-white">Privacy Built-in</h3>
                          <p className="text-gray-400 text-sm">Your API keys are stored locally. We never train on your data.</p>
                      </div>
      ...
      <section className="py-24 px-6 bg-zinc-900 text-white relative overflow-hidden border-y border-white/5">
           ...
           <div className="max-w-7xl mx-auto relative z-10">
               <div className="grid md:grid-cols-2 gap-16 items-center">
                   ...
                   <div className="relative">
                       ...
                       <div className="w-full h-80 bg-zinc-800 rounded-[32px] border border-zinc-700 absolute top-0 left-0 transform rotate-[-6deg] opacity-60"></div>
                       <div className="w-full h-80 bg-zinc-700 rounded-[32px] border border-zinc-600 absolute top-4 left-4 transform rotate-[-3deg] opacity-80"></div>
                       <div className="w-full h-80 bg-black/50 backdrop-blur-xl rounded-[32px] border border-zinc-600 relative p-8 flex flex-col justify-center items-center shadow-2xl">
                           <div className="flex gap-6">
                               <div className="w-20 h-20 bg-black border border-white/10 rounded-2xl flex items-center justify-center shadow-lg"><img src="https://upload.wikimedia.org/wikipedia/commons/e/e9/Notion-logo.svg" className="w-10 h-10 opacity-80"/></div>
                               <div className="w-20 h-20 bg-black border border-white/10 rounded-2xl flex items-center justify-center shadow-lg"><img src="https://upload.wikimedia.org/wikipedia/commons/1/19/Spotify_logo_without_text.svg" className="w-10 h-10 opacity-80"/></div>
                           </div>
                           <div className="mt-8 text-center">
                               <div className="bg-green-900/30 px-4 py-2 rounded-full text-sm font-mono text-green-400 border border-green-500/30">
                                   Status: Connected
                               </div>
                           </div>
                       </div>
